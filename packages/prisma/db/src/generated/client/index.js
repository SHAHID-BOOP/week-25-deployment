...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/shahid/Projects/week-25-ci-cd/packages/prisma/db/src/generated/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/shahid/Projects/week-25-ci-cd/packages/prisma/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../../.env"
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../db/src/generated/client\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id       String @id @default(uuid())\n  username String @unique\n  password String\n}\n",
  "inlineSchemaHash": "bca8a8be8abe21455410e394aad9305ee0034763208c46e39c0903a47ab3ef19",
  "copyEngine": true
}
...
path.join(process.cwd(), "../db/src/generated/client/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../db/src/generated/client/schema.prisma")
